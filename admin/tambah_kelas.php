...
<div style="margin: 30px 200px; background-color: rgb(255, 255, 255); box-shadow: black 2px 5px; box-shadow: #838383 0px -8px 20px; border-radius: 0px;">   
    <form action="proses_tambah_kelas.php" method="post" style="padding : 80px;">
        <h2>Tambah Kelas</h2>
        <br>
        Nama kelas :  
        <input type="text" name="nama_kelas" value="" class="form-control" require>
        <br>
        Kelompok :
        <br> 
        <input type="text" name="kelompok" value="" class="form-control" require>
        <br>
